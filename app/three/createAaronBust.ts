...
export function createAaronFacetedBustModel(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  const mesh_hairClumpCrownCenter_17Geometry = endpoint_hairClumpCrownCenter_17
    ...
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_hairClumpCrownCenter_17) {
    mesh_hairClumpCrownCenter_17Geometry.scale(0.3, 0.26, 0.3);
  }
  ...
  if (endpoint_hairClumpCrownLeft_18) {
    ...
    node_hairClumpCrownLeft_18.position.set(-0.2, 0.36, -0.1);
    node_hairClumpCrownLeft_18.rotation.set(0.0, 0.0, 0.0);
  }
  node_hairClumpCrownLeft_18.userData.sculptComponent = {"id": "hairClumpCrownLeft", "name": "Hair clump (crown, proper-left)", "level": "meso", "role": "body", "importance": 0.7, "confidence": 0.7, "primitive": "ellipsoid", "topologyClass": "assembled-solid", "topologyRationale": "Hair clump (crown, proper-left) is one of 9 stylized hair-clump primitives (reconstruction.md: prefer 5-15 clumps over strand geometry) forming the curl-cluster mass, not a single smooth dome.", "geometryDescriptor": {"topologyIntent": "stylized low-poly character part, flat-shaded facets left visible", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "flat face normals (flatShading:true) -- the facets ARE the surface language, never smoothed away"}, "parent": "head", "attachment": {"parentSocket": "origin", "localStart": [0, 0, 0], "localEnd": [0, 0, 0], "contactType": "overlap", "embedDepth": 0.03, "overlap": 0.03, "gapTolerance": 0.0}, "dimensions": {"width": 0.26, "height": 0.24, "depth": 0.28, "units": "relative", "confidence": 0.7}, "transform": {"position": [-0.2, 0.36, -0.1], "rotation": [0, 0, 0], "scale": [0.26, 0.24, 0.28]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": false, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "display prop only -- no physics"}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "hairClumpCrownLeft", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "hidden"}}, "material": "hair", "materialLayers": ["hair"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0.0, "microRoughness": 0.0, "bumpAmplitude": 0.0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": "Faceted low-poly: shading variation comes from real flat-normal lighting response, not painted-in gradients."}, "evidenceRefs": ["hairMass-zone"], "details": [], "fidelityTier": "form-refinement", "colorMaterialRecipe": {"dominantAlbedo": "rgba(168, 92, 58, 1.0)", "secondaryAlbedo": "rgba(100, 55, 34, 1.0)", "materialClass": "unknown", "materialClassConfidence": 0.6, "notes": "Flat faceted material -- secondaryAlbedo is a darker facet-shadow variant of the same hue, not a separate observed color zone."}};
  ...
  const mesh_hairClumpCrownLeft_18Geometry = endpoint_hairClumpCrownLeft_18
    ...
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_hairClumpCrownLeft_18) {
    mesh_hairClumpCrownLeft_18Geometry.scale(0.26, 0.24, 0.28);
  }
  ...
  if (endpoint_hairClumpCrownRight_19) {
    ...
    node_hairClumpCrownRight_19.position.set(0.16, 0.34, -0.1);
    node_hairClumpCrownRight_19.rotation.set(0.0, 0.0, 0.0);
  }
  node_hairClumpCrownRight_19.userData.sculptComponent = {"id": "hairClumpCrownRight", "name": "Hair clump (crown, proper-right)", "level": "meso", "role": "body", "importance": 0.6, "confidence": 0.7, "primitive": "ellipsoid", "topologyClass": "assembled-solid", "topologyRationale": "Hair clump (crown, proper-right) is one of 9 stylized hair-clump primitives (reconstruction.md: prefer 5-15 clumps over strand geometry) forming the curl-cluster mass, not a single smooth dome.", "geometryDescriptor": {"topologyIntent": "stylized low-poly character part, flat-shaded facets left visible", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "flat face normals (flatShading:true) -- the facets ARE the surface language, never smoothed away"}, "parent": "head", "attachment": {"parentSocket": "origin", "localStart": [0, 0, 0], "localEnd": [0, 0, 0], "contactType": "overlap", "embedDepth": 0.03, "overlap": 0.03, "gapTolerance": 0.0}, "dimensions": {"width": 0.22, "height": 0.2, "depth": 0.24, "units": "relative", "confidence": 0.7}, "transform": {"position": [0.16, 0.34, -0.1], "rotation": [0, 0, 0], "scale": [0.22, 0.2, 0.24]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": false, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "display prop only -- no physics"}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "hairClumpCrownRight", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "hidden"}}, "material": "hair", "materialLayers": ["hair"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0.0, "microRoughness": 0.0, "bumpAmplitude": 0.0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": "Faceted low-poly: shading variation comes from real flat-normal lighting response, not painted-in gradients."}, "evidenceRefs": ["hairMass-zone"], "details": [], "fidelityTier": "form-refinement", "colorMaterialRecipe": {"dominantAlbedo": "rgba(168, 92, 58, 1.0)", "secondaryAlbedo": "rgba(100, 55, 34, 1.0)", "materialClass": "unknown", "materialClassConfidence": 0.6, "notes": "Flat faceted material -- secondaryAlbedo is a darker facet-shadow variant of the same hue, not a separate observed color zone."}};
  ...
  const mesh_hairClumpCrownRight_19Geometry = endpoint_hairClumpCrownRight_19
    ...
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_hairClumpCrownRight_19) {
    mesh_hairClumpCrownRight_19Geometry.scale(0.22, 0.2, 0.24);
  }
  ...
  const mesh_hairClumpFrontFringe_23Geometry = endpoint_hairClumpFrontFringe_23
    ...
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_hairClumpFrontFringe_23) {
    mesh_hairClumpFrontFringe_23Geometry.scale(0.28, 0.16, 0.14);
  }
  ...
  // repetition system "hairClumps" describes 9 parts that are already built individually; not instanced.
