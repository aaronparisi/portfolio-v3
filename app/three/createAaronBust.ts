...
export function createAaronFacetedBustModel(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  node_torso_1.userData.sculptComponent = {"id": "torso", "name": "Upper torso (hoodie)", "level": "macro", "role": "body", "importance": 0.95, "confidence": 0.8, "primitive": "tapered-sweep", "topologyClass": "assembled-solid", "topologyRationale": "Torso is a tapered-sweep frustum (wide shoulders at the top station, narrower waist at the bottom crop) rather than a point-topped cone.", "geometryDescriptor": {"topologyIntent": "stylized low-poly character part, flat-shaded facets left visible", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "flat face normals (flatShading:true) -- the facets ARE the surface language, never smoothed away", "taperedSweep": {"stations": [{"position": [0.0, -0.5, 0.0], "rx": 0.25, "rz": 0.1375, "twist": 0.0}, {"position": [0.0, -0.15, 0.0], "rx": 0.3375, "rz": 0.18562500000000004, "twist": 0.0}, {"position": [0.0, 0.35, 0.0], "rx": 0.4625, "rz": 0.254375, "twist": 0.0}, {"position": [0.0, 0.5, 0.0], "rx": 0.5, "rz": 0.275, "twist": 0.0}], "radialSegments": 10, "capEnds": true}}, "parent": "root", "attachment": {"parentSocket": "origin", "localStart": [0, 0, 0], "localEnd": [0, 0, 0], "contactType": "flush", "embedDepth": 0.02, "overlap": 0.02, "gapTolerance": 0.0}, "dimensions": {"width": 1.95, "height": 1.78, "depth": 1.0725, "units": "relative", "confidence": 0.8}, "transform": {"position": [0, -0.89, 0], "rotation": [0, 0, 0], "scale": [1.95, 1.78, 1.0725]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": false, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "display prop only -- no physics"}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "torso", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "hidden"}}, "material": "hoodieFleece", "materialLayers": ["hoodieFleece"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["chest/underarm fold cluster (soft large-scale wrinkles)", "tapers from shoulder width to a narrower crop-bottom width"], "surfaceDetail": {"macroRoughness": 0.0, "microRoughness": 0.0, "bumpAmplitude": 0.0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": "Faceted low-poly: shading variation comes from real flat-normal lighting response, not painted-in gradients."}, "evidenceRefs": ["full-object", "torsoPanel-zone"], "details": [], "fidelityTier": "blockout", "colorMaterialRecipe": {"dominantAlbedo": "rgba(42, 38, 74, 1.0)", "secondaryAlbedo": "rgba(25, 22, 44, 1.0)", "materialClass": "fabric", "materialClassConfidence": 0.85, "notes": "Flat faceted material -- secondaryAlbedo is a darker facet-shadow variant of the same hue, not a separate observed color zone."}};
  ...
  const mesh_torso_1Geometry = endpoint_torso_1
    ...
    : buildTaperedSweepGeometry({"stations": [{"position": [0.0, -0.5, 0.0], "rx": 0.25, "rz": 0.1375, "twist": 0.0}, {"position": [0.0, -0.15, 0.0], "rx": 0.3375, "rz": 0.18562500000000004, "twist": 0.0}, {"position": [0.0, 0.35, 0.0], "rx": 0.4625, "rz": 0.254375, "twist": 0.0}, {"position": [0.0, 0.5, 0.0], "rx": 0.5, "rz": 0.275, "twist": 0.0}], "radialSegments": 10, "capEnds": true});
  if (!endpoint_torso_1) {
    mesh_torso_1Geometry.scale(1.95, 1.78, 1.0725);
  }
  ...
  mesh_torso_1.userData.sculptComponent = {"id": "torso", "name": "Upper torso (hoodie)", "level": "macro", "role": "body", "importance": 0.95, "confidence": 0.8, "primitive": "tapered-sweep", "topologyClass": "assembled-solid", "topologyRationale": "Torso is a tapered-sweep frustum (wide shoulders at the top station, narrower waist at the bottom crop) rather than a point-topped cone.", "geometryDescriptor": {"topologyIntent": "stylized low-poly character part, flat-shaded facets left visible", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "flat face normals (flatShading:true) -- the facets ARE the surface language, never smoothed away", "taperedSweep": {"stations": [{"position": [0.0, -0.5, 0.0], "rx": 0.25, "rz": 0.1375, "twist": 0.0}, {"position": [0.0, -0.15, 0.0], "rx": 0.3375, "rz": 0.18562500000000004, "twist": 0.0}, {"position": [0.0, 0.35, 0.0], "rx": 0.4625, "rz": 0.254375, "twist": 0.0}, {"position": [0.0, 0.5, 0.0], "rx": 0.5, "rz": 0.275, "twist": 0.0}], "radialSegments": 10, "capEnds": true}}, "parent": "root", "attachment": {"parentSocket": "origin", "localStart": [0, 0, 0], "localEnd": [0, 0, 0], "contactType": "flush", "embedDepth": 0.02, "overlap": 0.02, "gapTolerance": 0.0}, "dimensions": {"width": 1.95, "height": 1.78, "depth": 1.0725, "units": "relative", "confidence": 0.8}, "transform": {"position": [0, -0.89, 0], "rotation": [0, 0, 0], "scale": [1.95, 1.78, 1.0725]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": false, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "display prop only -- no physics"}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "torso", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "hidden"}}, "material": "hoodieFleece", "materialLayers": ["hoodieFleece"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["chest/underarm fold cluster (soft large-scale wrinkles)", "tapers from shoulder width to a narrower crop-bottom width"], "surfaceDetail": {"macroRoughness": 0.0, "microRoughness": 0.0, "bumpAmplitude": 0.0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": "Faceted low-poly: shading variation comes from real flat-normal lighting response, not painted-in gradients."}, "evidenceRefs": ["full-object", "torsoPanel-zone"], "details": [], "fidelityTier": "blockout", "colorMaterialRecipe": {"dominantAlbedo": "rgba(42, 38, 74, 1.0)", "secondaryAlbedo": "rgba(25, 22, 44, 1.0)", "materialClass": "fabric", "materialClassConfidence": 0.85, "notes": "Flat faceted material -- secondaryAlbedo is a darker facet-shadow variant of the same hue, not a separate observed color zone."}};
